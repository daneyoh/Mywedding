      ...
      <section className="pt-16 pb-8 px-8 bg-white text-center border-t border-zinc-100">
        ...
        <div className="text-left space-y-7 border-t border-zinc-100 pt-16 px-2">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm font-bold text-zinc-1200 flex items-center gap-2"><Car size={16} className="text-rose-400"/> 자가용 안내</p>
            <p className="text-[18px] text-zinc-700 leading-relaxed pl-6">빌라드지디 안양 제2주차장</p>
          </div>
          <div className="space-y-3">
            <p className="text-sm font-bold text-zinc-800 flex items-center gap-2"><MapPin size={16} className="text-rose-400"/> 주차장</p>
            <p className="text-[13px] text-zinc-500 leading-relaxed pl-6">
              안양시 동안구 관양동 791-10<br/>
              "빌라드지디 안양 제2주차장" 주차 후 셔틀버스 탑승 (5분거리)<br/>
              <span className="font-bold text-zinc-800 mt-2 block bg-rose-50 p-3 rounded-lg">**일반 하객분들은 빌라드지디 안양 제2주차장을 이용 부탁드립니다.**</span>
            </p>
          </div>
